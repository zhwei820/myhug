...
async def async_add_code(request, pnum: int, device_id: types.text, os_type: types.text, app_version: types.text, channel: types.text, package_name: types.text):
    """
    """
    code = VerifyLib.get_random_code()
...
def add_code(request, pnum: int, device_id: types.text, os_type: types.text, app_version: types.text, channel: types.text, package_name: types.text):
    """
    """
    code = VerifyLib.get_random_code()
