...
async def version(request, os_type: types.text, app_version: types.text, uid: types.int, ticket: types.text, rs: types.text, channel: types.text, package_name: types.text):
    """获取版本更新信息
